...
public class Moneytransfer extends HttpServlet {
   ...
   String Subject="Account Debited";
   String Message="Your Account Number = "+ y +"  is Debited with amount"
           + " "+ x +" through internet Banking Money Transfer to account "+recac;
 ...
 String to1=""+email1 +"";//change accordingly  
   String Subject1="Account Credited";
   String Message1="Your Account Number = "+ recac +"  is Credited with amount"
           + " "+ x +" through internet Banking Money Transfer from account "+y;
