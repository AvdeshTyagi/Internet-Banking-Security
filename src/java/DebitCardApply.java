...
public class DebitCardApply extends HttpServlet {
 ...
 String to1=""+email1 +"";//change accordingly  
   String Subject1="Debit Card Request";
   String Message1="We Successfully received your request to Issue Debit Card. "
           + "We will deliver it to your address as soon as possible. ";
