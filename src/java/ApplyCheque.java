...
public class ApplyCheque extends HttpServlet {
 ...
 String to1=""+email1 +"";//change accordingly  
   String Subject1="New Chequebook Request";
   String Message1="We Successfully received your request to issue a new chequebook. "
           + " it will deliver to your address as soon as possible ";
