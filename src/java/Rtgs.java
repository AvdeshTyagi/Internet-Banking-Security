...
public class Rtgs extends HttpServlet {
   ...
   String Message="Your Account Nummber = "+ y +"  is Debited with amount"
           + " "+ x +" through RTGS to account "+recac;
 ...
 String to1=""+email1 +"";//change accordingly  
   ...
   String Message1="Your Account Nummber = "+ recac +"  is Credited with amount"
           + " "+ x +" through RTGS from account "+y;
