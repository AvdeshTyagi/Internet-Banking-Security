...
public class BlockCredit1 extends HttpServlet {
 ...
 String to1=""+email1 +"";//change accordingly  
   String Subject1="Block Credit Card";
   String Message1="We Successfully received your request to Block Credit card("+cno+"). "
           + " Your Credit Card is now BLOCKED. ";
   ...
   SendMail.send(to1,Subject1, Message1, user1, pass1);   
           ...
           RequestDispatcher rd1=request.getRequestDispatcher("./succccblock.html");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BlockCredit</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BlockCredit at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");*/
        }
    }
