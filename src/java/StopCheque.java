 ...
 * @author Avdesh Tyagi
 */
public class StopCheque extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Long cno =Long.parseLong(request.getParameter("t3"));
    ...
    java.sql.Date ourJavaDateObject = new java.sql.Date(calendar.getTime().getTime());
            ResultSet rs;
             ...
             PreparedStatement ps=con.prepareStatement("select * from Account1 where acno=? and password=? ");
                 ...
                 String INSERT_RECORD = "insert into requesttable1(name,acno,type,cno,date2)values(?,?,?,?,?)";
    
    PreparedStatement pstmt = con.prepareStatement(INSERT_RECORD);
    pstmt.setString(1,name);
    pstmt.setLong(2,y);
    pstmt.setString(3, "STOP CHEQUE REQUEST");
   pstmt.setLong(4,cno);
   // pstmt.setLong(5,0);
    //pstmt.setLong(6,0);
 ...
 String to1=""+email1 +"";//change accordingly  
   String Subject1="Stop Cheque";
   String Message1="We Successfully received your request to Stop Cheque Payment of "
           + "Cheque Number= "+cno+". ";
           
   String user1="bankofbaroda05@gmail.com";
   String pass1="searmaan0573";
   SendMail.send(to1,Subject1, Message1, user1, pass1);   
           ...
           RequestDispatcher rd1=request.getRequestDispatcher("./succchblock.html");
                  ...
                  else
                  {
                        ...
                        RequestDispatcher rd2=request.getRequestDispatcher("./invalidpasschblock.html");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StopCheque</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StopCheque at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");*/
        }
    }
