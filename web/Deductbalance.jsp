<%-- 
    Document   : Deductbalance
    Created on : 29 Mar, 2016, 2:17:35 AM
    Author     : Avdesh Tyagi
--%>
...
<form style="text-align:left" name="frmLogin" onSubmit="return validate();" action="Deductbalance1.jsp" method="post">

    

<em> <center><h1>Deduct Balance</h1></center></em>
...
<input style="height:50px;  margin-left: 30px; width:100px;font-size:14pt; background-color:green" type="submit" value="Deduct Balance">
