<%-- 
    Document   : ManagerUpdateCust1
    Created on : 29 Mar, 2016, 6:25:55 AM
    Author     : Avdesh Tyagi
--%>
...
%>
<form action="ManagerUpdateCust2.jsp" method="post">
          
                
 <div><em><center><h2 style="color:black; font-family:cursive;" ><%=error%></h2></center></em></div>               
<em><h3></em><input style="height:40px;  margin-left: 35px; width:400px;font-size:14pt;" type="hidden" name="t1" value="<%=acno%>" ></h3>
...
<em><h3>password:</em><input style="height:40px;  margin-left: 98px; width:400px;font-size:14pt;" type="password" name="t7"></h3>
  ...
  <input style="height:50px;  margin-left: 400px; width:100px;font-size:14pt; background-color:teal" type="submit" value="Update">  
