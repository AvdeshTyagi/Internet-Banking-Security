<%-- 
    Document   : ManagerUpdateCust
    Created on : 29 Mar, 2016, 3:59:34 AM
    Author     : Avdesh Tyagi
--%>
...
<body>
	...
	<div id="tfheader">
		...
		<form name="frmLogin" onSubmit="return validate();" id="tfnewsearch" method="get" action="ManagerUpdateCust.jsp">
  ...
  %>
        ...
        <table id="customers">
          <tbody>
            ...
            <% while(rs.next()){ %>
            <form action="ManagerUpdateCust1.jsp" method="post">
            <TR>
