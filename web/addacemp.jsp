<%-- 
    Document   : addacemp
    Created on : 25 Mar, 2016, 11:57:45 PM
    Author     : Avdesh Tyagi
--%>
...
<form style="text-align:left" name="frmLogin" onSubmit="return validate();" action="addacemp1.jsp" method="post">

    

<em> <center><h1>Add Account</h1></center></em>
