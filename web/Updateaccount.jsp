<%-- 
    ...
    Created on : 29 Mar, 2016, 1:08:17 AM
    Author     : Avdesh Tyagi
--%>
...
<body>
	...
	<div id="tfheader">
		...
		<form name="frmLogin" onSubmit="return validate();" id="tfnewsearch" method="get" action="Updateaccount.jsp">
  ...
  %>
        ...
        <table id="customers">
          <tbody>
            ...
            <% while(rs.next()){ %>
            <form action="Updateaccount1.jsp" method="post">
            <TR>
