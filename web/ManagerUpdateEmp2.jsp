<%-- 
    Document   : ManagerUpdateEmp2
    Created on : 29 Mar, 2016, 6:54:15 AM
    Author     : Avdesh Tyagi
--%>
...
String cpass=request.getParameter("t7");
   ...
   String name=(String)session.getAttribute("Uname");
      ...
      if(cpass.equals(pass)){
            ...
            String req     = "Update Emp007 set fname='"+fname+"',lname='"+lname+"',address='"+address+"',mob="+cno+",email='"+email+"' where eid=?";
                PreparedStatement    ps=con.prepareStatement(req);
                 ...
                 int i= ps.executeUpdate();
                  ...
                  if(i>0){
                      ...
                      response.sendRedirect("ManagerUpdateEmp.jsp");
          ...
          String message="Invalid Password";
            response.sendRedirect("ManagerUpdateEmp1.jsp?error="+message);
