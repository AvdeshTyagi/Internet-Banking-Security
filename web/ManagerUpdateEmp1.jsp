<%-- 
    Document   : ManagerUpdateEmp1
    Created on : 29 Mar, 2016, 6:53:58 AM
    Author     : Avdesh Tyagi
--%>
...
%>
<form action="ManagerUpdateEmp2.jsp" method="post">
          
                
 <div><em><center><h2 style="color:black; font-family:cursive;" ><%=error%></h2></center></em></div>               
<em><h3></em><input style="height:40px;  margin-left: 35px; width:400px;font-size:14pt;" type="hidden" name="t1" value="<%=eid%>" ></h3>
