<%-- 
    Document   : NEFTstatement
    Created on : 29 Mar, 2016, 3:12:44 AM
    Author     : Avdesh Tyagi
--%>
...
<body>
	...
	<!-- HTML for SEARCH BAR -->
	<div id="tfheader">
            <em><center><h1>NEFT Statement</h1></center></em>
    ...
    <%
     ...
     Class.forName("oracle.jdbc.driver.OracleDriver");
           ...
           String message="User login successfully ";
            ...
            PreparedStatement ps=con.prepareStatement("select acno,drcr,amount,specification,type,date2 from statementtable where LOWER(type) like '%neft%' or type like '%NEFT%' order by date2 desc");
