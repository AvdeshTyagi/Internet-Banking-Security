<%-- 
    Document   : Manageraddemp
    Created on : 29 Mar, 2016, 3:51:28 AM
    Author     : Avdesh Tyagi
--%>
...
<form style="text-align:left" name="frmLogin" onSubmit="return validate();" action="Manageraddemp1.jsp" method="post">

    

<em> <center><h1>Add New Employee</h1></center></em>
...
<em><h3>Employee ID:</em><input style="height:30px;  margin-left: 98px; width:400px;font-size:14pt;" type="text" name="t3"></h3>
...
<em><h3>Post:</em><input style="height:30px;  margin-left: 162px; width:400px;font-size:14pt;" type="text" name="t7"></h3>
<em><h3>Salary:</em><input style="height:30px;  margin-left: 145px; width:400px;font-size:14pt;" type="text" name="t8"></h3>

<em><h3>Password:</em><input style="height:30px;  margin-left: 122px; width:400px;font-size:14pt;" type="password" name="t9"></h3>
