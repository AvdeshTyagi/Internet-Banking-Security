<%-- 
    Document   : ManagerUpdateEmp
    Created on : 29 Mar, 2016, 3:56:41 AM
    Author     : Avdesh Tyagi
--%>
...
<body>
	...
	<!-- HTML for SEARCH BAR -->
	<div id="tfheader">
            <em><center><h1>Update Account</h1></center></em>
		<form name="frmLogin" onSubmit="return validate();" id="tfnewsearch" method="get" action="ManagerUpdateEmp.jsp">
        ...
        <table id="customers">
          <tbody>
            <TR>
                ...
                <TH style="background-color: #4CAF50">Update</TH>
            </TR>
            <% while(rs.next()){ %>
            <form action="ManagerUpdateEmp1.jsp" method="post">
            <TR>
