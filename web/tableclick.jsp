<%-- 
    Document   : tableclick
    Created on : 26 Mar, 2016, 2:29:49 PM
    Author     : Avdesh Tyagi
--%>
...
<body>
	...
	<div id="tfheader">
		...
		<form name="frmLogin" onSubmit="return validate();" id="tfnewsearch" method="get" action="tableclick.jsp">
        ...
        <table id="customers">
          <tbody>
            ...
            <TR>
                ...
                <input type="hidden" id="002" name="t2" value="<%= rs.getString(2) %>"/>
                <TD> <%= rs.getString(3) %></td>
                <input type="hidden" id="003" name="t3" value="<%= rs.getString(3) %>"/>
                <TD> <%= rs.getString(4) %></td>
                <input type="hidden" id="004" name="t4" value="<%= rs.getString(4) %>"/>
                <TD> <%= rs.getLong(5) %></td>
                 <input type="hidden" id="005" name="t5" value="<%= rs.getLong(5) %>"/>
                <TD> <%= rs.getString(6) %></TD>
                <input type="hidden" id="004" name="t6" value="<%= rs.getString(6) %>"/>
