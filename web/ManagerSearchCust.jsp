<%-- 
    Document   : ManagerSearchCust
    Created on : 29 Mar, 2016, 3:58:01 AM
    Author     : Avdesh Tyagi
--%>
...
<body>
	...
	<div id="tfheader">
		...
		<form name="frmLogin" onSubmit="return validate();" id="tfnewsearch" method="get" action="ManagerSearchCust.jsp">
