<%-- 
    Document   : ManagerChangePass
    Created on : 29 Mar, 2016, 3:53:28 AM
    Author     : Avdesh Tyagi
--%>
...
<form style="text-align:left" name="frmLogin" onSubmit="return validate();" action="ManagerChangePass1.jsp" method="post">
