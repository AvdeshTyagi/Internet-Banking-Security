<%-- 
    Document   : passwordchangedemp
    Created on : 25 Mar, 2016, 9:07:22 PM
    Author     : Avdesh Tyagi
--%>
...
<%
    ...
    if(rsdoLogin.next())
    {
     ...
     PreparedStatement ps=conn.prepareStatement("update Emp007 set password='"+newpass1+ "' where username=? and password=? ");
                  ps.setString(1, name);
      ...
      response.sendRedirect("changepassemp.jsp?error="+message);
    }
    else
    {
