<%-- 
    Document   : addbalance
    Created on : 28 Mar, 2016, 4:38:54 AM
    Author     : Avdesh Tyagi
--%>
...
<%
    ...
    psdoLogin.setString(3, "Cr");
    psdoLogin.setLong(4,amount);
    psdoLogin.setString(5,"fund received from Bank");
         psdoLogin.setString(6,"CASH RECEIVED");
         ...
         int i=psdoLogin.executeUpdate();
          response.sendRedirect("addbalanceemp.jsp?error="+message);
    }
    else
    {
