<%-- 
    Document   : viewapprovedrequest
    Created on : 28 Mar, 2016, 4:10:53 AM
    Author     : Avdesh Tyagi
--%>
...
<div id="nav1">
     ...
     <a href=" http://localhost:15693/Banking/newwel.html">
     <div id="nav22">
...
<a href="http://localhost:15693/Banking/viewbalance.jsp">
  <div id="nav23">
 ...
 <a href="http://localhost:15693/Banking/Moneytransfer.html">   
<div id="nav24">
    ...
    <a href="http://localhost:15693/Banking/viewprofile.jsp">
<div id="nav25">
...
<a href="http://localhost:15693/Banking/passwordchange1.html">    
<div id="nav26">
    ...
    <a href="http://localhost:15693/Banking/viewstatement.jsp">
<div id="nav27">
...
<a href=" http://localhost:15693/Banking/rtgss1.html">    
<div id="nav28">
...
<a href=" http://localhost:15693/Banking/neftr1.html">    
<div id="nav29">
...
<a href=" http://localhost:15693/Banking/blockdebit1.html">    
<div id="nav30">
...
<a href="  http://localhost:15693/Banking/blockcredit.html">    
<div id="nav31">
...
th, td {
    ...
    <body>
        ...
        <em> <center><h1>Request Approved </h1></center></em> 
 ...
 <%@ page import = "java.sql.*" %>
  ...
  //ResultSet rs = 
        ...
        //PreparedStatement ps=con.prepareStatement("select balance from Account1 where password=? ");
            PreparedStatement ps=con.prepareStatement("select name,type,dcno,ccno,cno,date2 from REQUESTAPPROVED11 where acno=? ");
                  ps.setLong(1, acnu);
