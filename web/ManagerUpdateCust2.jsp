<%-- 
    Document   : ManagerUpdateCust2
    Created on : 29 Mar, 2016, 6:26:09 AM
    Author     : Avdesh Tyagi
--%>
   ...
   String name=(String)session.getAttribute("Uname");
      ...
      if(cpass.equals(pass)){
                ...
                PreparedStatement    ps=con.prepareStatement(req);
                 ...
                 int i= ps.executeUpdate();
                  ...
                  if(i>0){
                      ...
                      response.sendRedirect("ManagerUpdateCust.jsp");
          ...
          String message="Invalid Password";
            response.sendRedirect("ManagerUpdateCust1.jsp?error="+message);
